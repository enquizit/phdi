...
public class Constant {
  ...
  private Constant() {//All methods are static,  public constructor is meaningless
  }
  ...
  public static final String PROCESS_ALGORITHM = "Request ID: %s - Processing Algorithm: %s - version: %s " ;
