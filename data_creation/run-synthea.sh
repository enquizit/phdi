#!/bin/bash
# generate_synthetic.sh: Script to generate synthetic data using Synthea and export to CSV
#
# Arguments:
...
java -jar ./assets/synthea-with-dependencies.jar --exporter.csv.export=true \
